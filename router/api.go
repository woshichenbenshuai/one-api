	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/self/authenticator", controller.GetAuthenticatorStatus)
				selfRoute.POST("/self/authenticator/setup", controller.SetupAuthenticator)
				selfRoute.POST("/self/authenticator/enable", controller.EnableAuthenticator)
				selfRoute.POST("/self/authenticator/disable", controller.DisableAuthenticator)
